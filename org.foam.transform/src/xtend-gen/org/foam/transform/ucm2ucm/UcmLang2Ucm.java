...
public class UcmLang2Ucm {
  ...
  private final String PRIMARY = "Primary:\\s+(\\w+)";
  ...
  private final Pattern UCIDANDNAME_PATTERN = new Function0<Pattern>() {
    public Pattern apply() {
      ...
      _builder.append(UcmLang2Ucm.this.UC_REGEXP, "");
      _builder.append(" \\\\s+(.*)");
      ...
      while (_while) {
        {
          ...
          if (_not_1) {
            ...
            int _minus = (-1);
            throw new ParseException(_builder_1.toString(), _minus);
          }
          int _length = prefix.length();
          int _minus_1 = (_length - 1);
          final String stepLabel = prefix.substring(0, _minus_1);
          ...
          if (_not_2) {
            ...
            int _minus_2 = (-1);
            throw new ParseException(_builder_2.toString(), _minus_2);
          }
          ...
          if (_notEquals) {
            ...
            int _minus_3 = (-1);
            throw new ParseException(_builder_3.toString(), _minus_3);
          }
        ...
        while (_while) {
          {
            ...
            boolean _not_1 = (!firstLineMatched);
            if (_not_1) {
              boolean _or = false;
