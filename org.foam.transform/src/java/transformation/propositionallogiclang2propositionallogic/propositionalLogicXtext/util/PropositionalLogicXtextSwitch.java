 ...
 * @generated
 */
public class PropositionalLogicXtextSwitch<T> extends Switch<T>
{
  /**
   ...
   * @generated
   */
  public PropositionalLogicXtextSwitch()
  {
   ...
   */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case PropositionalLogicXtextPackage.RULE_VARIABLE_USE: {
			RuleVariableUse ruleVariableUse = (RuleVariableUse) theEObject;
			T result = caseRuleVariableUse(ruleVariableUse);
			if (result == null)
				result = caseFormula(ruleVariableUse);
			if (result == null)
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Rule Variable Use</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Rule Variable Use</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRuleVariableUse(RuleVariableUse object)
  {
    return null;
  }
