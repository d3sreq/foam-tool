...
public class CreateEdgeTransitionProcessor implements TransitionProcessor {
          ...
          for (final Action action : _filter) {
            {
              ...
              String _plus_2 = (_plus_1 + Boolean.valueOf(_isValue));
              CreateEdgeTransitionProcessor.this.addTooltip(it, _plus_2);
            }
          }
  ...
  public void addTooltip(final Edge edge, final String tooltipStr) {
    ...
    boolean _equals = Objects.equal(tooltipAttr, null);
    if (_equals) {
      _xifexpression = "";
    } else {
      _xifexpression = (tooltipAttr + "; ");
    }
    final String newTooltipAttr = (_xifexpression + tooltipStr);
    EMap<String,String> _attributes_1 = edge.getAttributes();
    _attributes_1.put("tooltip", newTooltipAttr);
  }
