      ...
      if (Objects.equal(_head,"mark")) {
        ...
        final Procedure1<Mark> _function_2 = new Procedure1<Mark>() {
          public void apply(final Mark it) {
            ...
            VariableDefinition _findOrAddVariableDefinition = FlowAnnotationResolver.this.findOrAddVariableDefinition((FlowAnnotationResolver.MARK_PREFIX + varName), varName2VarDef, useCaseModel);
    ...
    for (final RuleVariableUse ruleVar : ruleVars) {
      {
        ...
        final String varName = (FlowAnnotationResolver.MARK_PREFIX + _variable);
