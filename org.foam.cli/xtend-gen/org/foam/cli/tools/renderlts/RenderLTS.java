  ...
  public void execute(final String[] args) {
    try {
      ...
      if (_and_1) {
        ...
        _xifexpression_1 = (inputLtsFileName + "output.dot");
      }
      ...
      _builder_1.append("Reading input LTS from file \"");
      _builder_1.append(inputLtsFileName, "");
      _builder_1.append("\"");
      ...
      _builder_2.append("Reading configuration graph template from \"conf/GraphTemplate.xmi\"");
      ...
      _builder_4.append("Validating configuration graph template");
      this.info(_builder_4);
      EmfCommons.basicValidate(initGraph);
      StringConcatenation _builder_5 = new StringConcatenation();
      _builder_5.append("Running the transformation");
      ...
      _builder_6.append("Writing the result DOT code to \"");
      _builder_6.append(outputFileName, "");
      _builder_6.append("\"");
      ...
      if (_has_3) {
        Iterables.<String>addAll(dotCommand, Collections.<String>unmodifiableList(Lists.<String>newArrayList("-Tpdf", "-o", (outputFileName + ".pdf"))));
      }
      boolean _or = false;
      ...
      if (_or) {
        Iterables.<String>addAll(dotCommand, Collections.<String>unmodifiableList(Lists.<String>newArrayList("-Tpng", "-o", (outputFileName + ".png"))));
      }
      boolean _or_1 = false;
      ...
      if (_or_1) {
        Iterables.<String>addAll(dotCommand, Collections.<String>unmodifiableList(Lists.<String>newArrayList("-Tcmapx", "-o", (outputFileName + ".cmapx"))));
      }
      ...
      if (_not) {
        ...
        _builder_7.append("Running Graphviz DOT tool: ");
        String _join = IterableExtensions.join(dotCommand, " ");
        _builder_7.append(_join, "");
      ...
      if (_has_8) {
        ...
        _builder_8.append("Writing HTML to \"");
        _builder_8.append((outputFileName + ".html"), "");
        _builder_8.append("\"");
        this.info(_builder_8);
        File _file_1 = new File((outputFileName + ".cmapx"));
        ...
        _builder_9.append("<html>");
        _builder_9.newLine();
        _builder_9.append("<body>");
        _builder_9.newLine();
        _builder_9.append("<img src=\"");
        _builder_9.append((outputFileName + ".png"), "");
        _builder_9.append("\" ismap=\"ismap\" usemap=\"#mygraph\"/>");
        _builder_9.newLineIfNotEmpty();
        _builder_9.append(imageMapContent, "");
        _builder_9.newLineIfNotEmpty();
        _builder_9.append("</body>");
        _builder_9.newLine();
        _builder_9.append("</html>");
        _builder_9.newLine();
        File _file_2 = new File((outputFileName + ".html"));
        Files.write(_builder_9, _file_2, Charsets.UTF_8);
      }
      this.info("done");
    } catch (Throwable _e) {
