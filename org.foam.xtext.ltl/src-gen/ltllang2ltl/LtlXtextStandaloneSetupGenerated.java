...
public class LtlXtextStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjectorAndDoEMFRegistration() {
		propositionallogiclang2propositionallogic.PropositionalLogicXtextStandaloneSetup.doSetup();
	...
	public Injector createInjector() {
		return Guice.createInjector(new ltllang2ltl.LtlXtextRuntimeModule());
	}
