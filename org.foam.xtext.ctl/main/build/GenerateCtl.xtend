...
class GenerateCtl {
	def static void main(String[] args) {
	    ...
	    new File("main/src/org/foam/xtext/ctl/CtlLogicXtextRuntimeModule.java").delete
	    new File("main/src/org/foam/xtext/ctl/CtlLogicXtextStandaloneSetup.java").delete
...
//			addRegisterGenModelFile = "platform:/resource/org.foam.models/models/propositionallogic.genmodel"
	    ...
	    new DirectoryCleaner => [
	    	directory = '''«runtimeProject»/main/src/org/foam/xtext/ctl'''
