...
import lts2dot.processor.state.AddScenarioStateProcessor
import lts2dot.processor.state.AddUseCaseStateProcessor
import lts2dot.processor.state.CircleWithoutStateTypeProcessor
import lts2dot.processor.state.CreateNodeStateProcessor
import lts2dot.processor.state.CreateOverviewNodeStateProcessor
import lts2dot.processor.state.StateProcessor
import lts2dot.processor.state.StyleIncludeNodeStateProcessor
import lts2dot.processor.state.color.BlackInitStateProcessor
import lts2dot.processor.state.color.GreenSuccessStateProcessor
import lts2dot.processor.state.color.RedAbortStateProcessor
import lts2dot.processor.state.label.BulletInnerNodeStateProcessor
import lts2dot.processor.state.label.XlabelStepStateProcessor
import lts2dot.processor.transition.CreateEdgeTransitionProcessor
import lts2dot.processor.transition.CreateOverviewEdgeTransitionProcessor
import lts2dot.processor.transition.RemoveRecordNodeEdgeTransitionProcessor
import lts2dot.processor.transition.TransitionProcessor
