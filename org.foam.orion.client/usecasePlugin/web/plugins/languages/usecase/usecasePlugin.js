...
define(['orion/plugin', 'orion/form', 'orion/editor/stylers/text_x-usecase/syntax'], function (PluginProvider, form, mGo) {

	/**
	 * Plug-in headers
	 */
	var headers = {
		name: "Orion usecase Language Tool Support",
		version: "1.0",
		description: "This plugin provides usecase language tools support for Orion."
	};
