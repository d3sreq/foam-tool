...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>All Globally</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.foam.ctl.impl.AllGloballyImpl#getFormula <em>Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AllGloballyImpl extends MinimalEObjectImpl.Container implements AllGlobally
{
	/**
	...
	{
		return CtlPackage.Literals.ALL_GLOBALLY;
	}
	...
	public void setFormula(Formula newFormula)
	{
		if (newFormula != formula) {
			...
			if (newFormula != null)
				msgs = ((InternalEObject)newFormula).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CtlPackage.ALL_GLOBALLY__FORMULA, null, msgs);
			msgs = basicSetFormula(newFormula, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CtlPackage.ALL_GLOBALLY__FORMULA, newFormula, newFormula));
	}
