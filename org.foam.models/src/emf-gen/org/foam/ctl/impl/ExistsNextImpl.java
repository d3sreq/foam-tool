...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Exists Next</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.foam.ctl.impl.ExistsNextImpl#getFormula <em>Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExistsNextImpl extends MinimalEObjectImpl.Container implements ExistsNext
{
	/**
	...
	{
		return CtlPackage.Literals.EXISTS_NEXT;
	}
	...
	public void setFormula(Formula newFormula)
	{
		if (newFormula != formula)
		{
			...
			if (newFormula != null)
				msgs = ((InternalEObject)newFormula).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CtlPackage.EXISTS_NEXT__FORMULA, null, msgs);
			msgs = basicSetFormula(newFormula, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CtlPackage.EXISTS_NEXT__FORMULA, newFormula, newFormula));
	}
