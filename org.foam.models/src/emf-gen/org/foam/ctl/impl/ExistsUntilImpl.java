 ...
 * <ul>
 *   <li>{@link org.foam.ctl.impl.ExistsUntilImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.foam.ctl.impl.ExistsUntilImpl#getRight <em>Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExistsUntilImpl extends MinimalEObjectImpl.Container implements ExistsUntil
{
	/**
	...
	public void setLeft(Formula newLeft)
	{
		if (newLeft != left) {
			...
			if (newLeft != null)
				msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CtlPackage.EXISTS_UNTIL__LEFT, null, msgs);
			msgs = basicSetLeft(newLeft, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CtlPackage.EXISTS_UNTIL__LEFT, newLeft, newLeft));
	}
	...
	public void setRight(Formula newRight)
	{
		if (newRight != right) {
			...
			if (newRight != null)
				msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CtlPackage.EXISTS_UNTIL__RIGHT, null, msgs);
			msgs = basicSetRight(newRight, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CtlPackage.EXISTS_UNTIL__RIGHT, newRight, newRight));
	}
