 ...
 * <ul>
 *   <li>{@link org.foam.propositionallogic.impl.OrImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.foam.propositionallogic.impl.OrImpl#getRight <em>Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrImpl extends MinimalEObjectImpl.Container implements Or
{
	...
	{
		return PropositionallogicPackage.Literals.OR;
	}
	...
	public void setLeft(Formula newLeft)
	{
		if (newLeft != left)
		{
			...
			if (newLeft != null)
				msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PropositionallogicPackage.OR__LEFT, null, msgs);
			msgs = basicSetLeft(newLeft, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PropositionallogicPackage.OR__LEFT, newLeft, newLeft));
	}
	...
	public void setRight(Formula newRight)
	{
		if (newRight != right)
		{
			...
			if (newRight != null)
				msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PropositionallogicPackage.OR__RIGHT, null, msgs);
			msgs = basicSetRight(newRight, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PropositionallogicPackage.OR__RIGHT, newRight, newRight));
	}
