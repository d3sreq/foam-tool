 ...
 * <ul>
 *   <li>{@link org.foam.propositionallogic.impl.NotImpl#getFormula <em>Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotImpl extends MinimalEObjectImpl.Container implements Not
{
	...
	public void setFormula(Formula newFormula)
	{
		if (newFormula != formula)
		{
			...
			if (newFormula != null)
				msgs = ((InternalEObject)newFormula).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PropositionallogicPackage.NOT__FORMULA, null, msgs);
			msgs = basicSetFormula(newFormula, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PropositionallogicPackage.NOT__FORMULA, newFormula, newFormula));
	}
