 ...
 * <ul>
 *   <li>{@link org.foam.propositionallogic.impl.VariableDefinitionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableDefinitionImpl extends MinimalEObjectImpl.Container implements VariableDefinition
{
	...
	{
		return PropositionallogicPackage.Literals.VARIABLE_DEFINITION;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PropositionallogicPackage.VARIABLE_DEFINITION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case PropositionallogicPackage.VARIABLE_DEFINITION__NAME:
				return getName();
		}
