...
public class AnnotationSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case AnnotationPackage.ANNOTABLE:
			{
			...
			case AnnotationPackage.UNKNOWN_ANNOTATION:
			{
				UnknownAnnotation unknownAnnotation = (UnknownAnnotation)theEObject;
				T result = caseUnknownAnnotation(unknownAnnotation);
				if (result == null) result = caseAnnotation(unknownAnnotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Unknown Annotation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Unknown Annotation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUnknownAnnotation(UnknownAnnotation object)
	{
		return null;
	}
