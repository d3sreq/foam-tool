/**
 */
package org.foam.annotation.util;
...
public class AnnotationAdapterFactory extends AdapterFactoryImpl
{
	...
	protected AnnotationSwitch<Adapter> modelSwitch =
		new AnnotationSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseUnknownAnnotation(UnknownAnnotation object)
			{
				return createUnknownAnnotationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.foam.annotation.UnknownAnnotation <em>Unknown Annotation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUnknownAnnotationAdapter()
	{
		return null;
	}
